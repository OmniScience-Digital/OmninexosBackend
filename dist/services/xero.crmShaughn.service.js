...
async function handleCrmShaughnTask(quote, action) {
    ...
    await updateClickUpTask(quote.clickUpTaskidCrmShaughn, payload.topic, payload.description, payload.status);
    if (payload.comment)
...
async function updateClickUpTask(taskId, topic, description, status) {

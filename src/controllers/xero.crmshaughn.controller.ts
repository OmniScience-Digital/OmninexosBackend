...
import { Quote, XeroQuotesResponse } from '../schema/xero.schema';
...
export const xeroCrmShaughnController = {
   ...
   */
  syncQuote: async (req: Request, res: Response) => {
    try {
...
export const xeroCrmShaughnManagementController = {
   ...
   */
  resyncQuoteByNumber: async (req: Request, res: Response) => {
    try {
      ...
      const data = (await xeroRes.json()) as XeroQuotesResponse;

...
export const createInvoice = async (quoteItem: any) => {
...
export async function getInvByXeroInvoiceId(xeroInvoiceId: string) {
  const params = {
    TableName: INVOICE_TABLE,
...
export async function getInvByXeroInvoiceNumber(xeroInvoicenumb: string) {
  const params = {
    TableName: INVOICE_TABLE,
...
export const updateInvoice = async (pkId: string, updates: any) => {
